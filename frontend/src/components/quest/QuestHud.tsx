        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <div className="flex items-center gap-1.5">
              <span className="font-display text-lg font-bold text-slate-900">Sarthi</span>
              <span className="rounded bg-blue-50 px-1 py-0.2 text-[9px] font-semibold text-blue-600 border border-blue-200">
                AI
              </span>
            </div>
