      ...
      POST: async ({ request }) => {
        try {
          ...
          if (!Array.isArray(messages)) {
            logTerminalActivity(
              "Sarthi Chat Mentor Agent (Nvidia NIM: nemotron-3-ultra-550b-a55b)",
              false,
          ...
          const result = streamText({
            ...
            system: `You are Sarthi, the AI Project Mentor and guide (inspired by Krishna guiding Arjun with wisdom and clarity), helping a final-year student navigate their project.
